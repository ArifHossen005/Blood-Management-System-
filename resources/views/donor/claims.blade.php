@extends('layouts.app')
@section('title', __('ui.certificate.my_claims'))
@section('page-title', __('ui.certificate.my_claims'))
...
<div class="table-card p-4 mb-4">
    ...
    <form method="POST" action="{{ route('donor.claims.store') }}">
        @csrf
        <div class="row g-3">
            <div class="col-md-4">
            ...
            <tbody>
                @forelse($claims as $claim)
                    <tr>
                        ...
                        <td>
                            @if($claim->status === 'approved')
                                <a href="{{ route('donor.certificate', $claim) }}" class="btn btn-sm btn-blood">
                                    <i class="bi bi-award me-1"></i>{{ __('ui.certificate.view_certificate') }}
                                </a>
                                <a href="{{ route('donor.certificate.download', $claim) }}" class="btn btn-sm btn-outline-secondary ms-1">
