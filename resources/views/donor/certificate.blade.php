...
.cert-header .cert-app-name {
    font-size: 1.05rem; letter-spacing: 3px; text-transform: uppercase;
    opacity: .85; margin: 0 0 6px; font-weight: 600;
}
...
.cert-header .cert-subtitle {
    font-size: 0.78rem; letter-spacing: 2px; opacity: .7; margin: 0;
}
...
.cert-avatar-ring {
    ...
    box-shadow: 0 0 0 3px #D4AF37, 0 6px 20px rgba(220,20,60,.3);
    overflow: hidden; margin: 0 auto 16px; background: #f0f0f0;
}
...
.cert-blood-badge {
    ...
    box-shadow: 0 3px 10px rgba(220,20,60,.35);
    margin-bottom: 20px;
}
...
.cert-bangla {
    font-size: 1.4rem; font-weight: 700; color: #8B0000;
...
<div class="certificate-wrap">
    ...
    <div class="d-flex flex-wrap gap-2 mb-3 cert-actions">
        <a href="{{ route('donor.certificate.download', $claim) }}" class="btn btn-blood btn-sm">
        ...
        <a href="{{ route('donor.claims') }}" class="btn btn-sm btn-link text-muted">
